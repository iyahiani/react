                ...
                <section className="row">
                    ...
                    <section className="col12 col-md-6 mb3">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure, quos cumque ab labore nulla,
                            laborum perferendis incidunt minus, quam accusamus qui. Ipsum, rerum! Provident delectus
                            velit
                        ...
                        <p>Sint deleniti laboriosam autem aperiam eos tenetur voluptatibus laudantium dolor dignissimos
                            perspiciatis iste ipsum maiores, asperiores corrupti necessitatibus distinctio? Mollitia
                            maiores
                            quis consequatur quia architecto. Beatae debitis ad delectus neque!</p>
                        <button className="btn btn-primary" data-bs-toggle="collapse"
                                data-bs-target="#panneau"> Panneau1
                        </button>
                        <div className="collapse border p-3" id="panneau">
                            Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
                        </div>
                        <div className="accordion pt-2" id="accordeonParent">
                            <div className="accordion-item">
                                ...
                                <section className="accordion-body collapse show" id="section"
                                         data-bs-parent="#accordeonParent">
                            ...
                            <div className="accordion-item">
                                <h2 className="accordion-header">
                                    <button type="button" className="accordion-button collapsed"
                                            ...
                                            data-bs-target="#section2">Accordéon 2
                                    </button>
                                </h2>
                                <section className="accordion-body collapse" id="section2"
                                         data-bs-parent="#accordeonParent">
                                    Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod
                                    tempor
                                    invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et
