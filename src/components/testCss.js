...
const TestCss = () => {
    ...
    return (
        <div>
            ...
            <section
                className="bg-warning m-5 d-flex justify-content-center justify-content-md-start align-items-stretch align-items-md-baseline"
                style={{height: "200px"}}>
                <div className="border border-primary p-3">neque volumus in duis dolorum partiendo tincidunt nonumy
                </div>
                <div className="border border-primary p-3">neque volumus in duis dolorum partiendo tincidunt nonumy
            ...
            <section className="bg-warning m-5 d-flex" style={{height: "200px"}}>
                ...
                <div className="border border-primary p-3 align-self-center">neque volumus in duis dolorum partiendo
                    tincidunt nonumy
                </div>
                <div className="border border-primary p-3">neque volumus in duis dolorum partiendo tincidunt nonumy
                </div>
